...
class GifClickImage extends StatefulWidget {
  final String image;

  const GifClickImage( this.image);

  @override
  _GifClickImageState createState() => _GifClickImageState();
}

class _GifClickImageState extends State<GifClickImage> {
