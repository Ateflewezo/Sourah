...
import 'package:hdwallpapers/GifClicks/GifClickImage.dart';
...
class GiftItemClick extends StatefulWidget {
  final String id;

  const GiftItemClick(this.id);

  _GiftItemClickState createState() => _GiftItemClickState();
}

class _GiftItemClickState extends State<GiftItemClick> {
  // String _message = "";
  var filepath;
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => GifClickImage(data["image"]),
          ),
        );
      },
      child: data == null
