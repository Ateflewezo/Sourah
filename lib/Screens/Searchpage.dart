...
//            colorss(),
               widget.data.length == 0 
                  ?  Padding(
                    ...
                    child: Center(
                      child: Text("لا يوجد نتائج بحث ,حاول بكلمات أخري" , style: TextStyle(color: Colors.white),), 
                    ),
                  )
                  : GridView.builder(
                  shrinkWrap: true,
                    ...
                    return InkWell(
                      onTap: (){
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) =>FirstItemClick("${widget.data[index]["id"]}"),
                          ),
                        );
                      },
                      child: gridItem(widget.data[index]["name"] != null ? widget.data[index]["name"] : "",
...
//-----------------------griditem----------------
  Widget gridItem(String text,String image) {
    return Stack(
      children: <Widget>[
        Column(
          children: <Widget>[
